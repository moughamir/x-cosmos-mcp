...
async def create_tables():
    ...
    try:
        ...
        await conn.execute("CREATE INDEX IF NOT EXISTS idx_products_llm_confidence ON products(llm_confidence)")
        await conn.execute("CREATE INDEX IF NOT EXISTS idx_products_category ON products(category)")
        await conn.execute("CREATE INDEX IF NOT EXISTS idx_changes_log_product_id ON changes_log(product_id)")
        await conn.execute("CREATE INDEX IF NOT EXISTS idx_changes_log_created_at ON changes_log(created_at)")
        await conn.execute("CREATE INDEX IF NOT EXISTS idx_pipeline_runs_status ON pipeline_runs(status)")
        await conn.execute("CREATE INDEX IF NOT EXISTS idx_pipeline_runs_start_time ON pipeline_runs(start_time)")
