...
TAXONOMY_PATH = os.path.join(PROJECT_ROOT, 'taxonomy.en-US.txt')
...
def load_taxonomy() -> Dict[str, TaxonomyNode]:
    """Loads the Google taxonomy list from local file and builds a hierarchical tree."""
    ...
    print("Loading Google Product Taxonomy from local file and building tree...")
