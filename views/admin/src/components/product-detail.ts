    ...
    return html`
      <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">
          Product Detail: ${this.product.title}
        </h1>
        ...
        <div class="form-group">
          ...
          <input
            ...
            id="title"
            name="title"
            .value="${this.editedProduct.title || ''}"
        ...
        <div class="form-group">
          ...
          <input
            ...
            .value="${this.editedProduct.normalized_title || ''}"
            @input="${this.handleInputChange}" />
        </div>
        <div class="form-group">
          ...
          <textarea
            ...
            .value="${this.editedProduct.normalized_body_html || ''}"
            @input="${this.handleInputChange}"></textarea>
        </div>
        <div class="form-group">
          ...
          <input
            ...
            .value="${this.editedProduct.gmc_category_label || ''}"
            @input="${this.handleInputChange}" />
        </div>
        <div class="form-group">
          ...
          <input
            ...
            id="llm_confidence"
            name="llm_confidence"
            .value="${this.editedProduct.llm_confidence || ''}"
            @input="${this.handleInputChange}" />
        </div>
                ...
                ${this.changes.map(
                  (change) => html`
                    <div class="change-entry">
                      ...
                      <p>
                        <strong>Reviewed:</strong> ${change.reviewed
                          ? 'Yes'
                          : 'No'}
                      </p>
                    </div>
