...
class WorkerPool:
    ...
    async def submit_task(self, task_type: str, data: Any, priority: int = 0, retry_count: int = 0) -> str:
        ...
        logger.debug(f"Submitted task {task_id} with priority {priority} (retry: {retry_count})")
    ...
    async def _health_check(self):
        ...
        for worker in self.workers:
            ...
            if (worker.status == WorkerStatus.BUSY and
                ...
                current_time - worker.current_task.created_at > 300):
